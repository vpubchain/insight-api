...
BlockController.prototype.list = function(req, res) {
  ...
  https.get("https://pl.vpubchain.net/ext/getblockhashbytime/"+lte+"/"+gte,function (res) {  
    var datas = [];  
    var size = 0;  
    ...
    res.on("end", function () {  
        ...
        var hashes = iconv.decode(buff, "utf8");//转码//var result = buff.toString();//不需要转编码,直接tostring  
